...
public val IconPack.CancelRole: ImageVector
    get() {
        if (_cancelRole != null) {
            return _cancelRole!!
        }
        _cancelRole = Builder(name = "CancelRole", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cancelRole: ImageVector? = null
